...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # TODO: This doesnt work on initial setup because the `schedule`
        # mirations haven't ran yet and the table doesnt exist. How can you
        # reliably load fixtures for third party apps?
#        call_command("loaddata", "openduty/fixtures/schedule_rules.json")
